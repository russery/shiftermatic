	...
	; Compiler options:
	;
	; -oShifterMatic.cof -mShifterMatic.map --summary=default \
	; --output=default ShiftermaticMain.p1 Serial.p1 Timer.p1 HAL.p1 \
	; --chip=12F683 -P --runtime=default --opt=default -D__DEBUG=1 -g \
